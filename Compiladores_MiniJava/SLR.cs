                    ...
                    switch (PilaEstados.Peek())
                    {
                        ...
                        case 69:
                            ...
                            else if (Lab_ASDR.TokenList[i] == "ident")
                            {
                                ...
                                var proPrec = PrecedenciaProducciones[47];
                                if (proPrec >= terPrec)
                                {
                                    //r47
                                    AccionReduccion(47);
                        ...
                        case 81:
                            ...
                            else if (Lab_ASDR.TokenList[i] == "static")
                            {
                                ...
                                var terPrec = PrecedenciaTerminales[Lab_ASDR.TokenList[i]];
                                //PRECEDENCIA DE LA PRODUCCION
                                var proPrec = PrecedenciaProducciones[49];
                                if (proPrec >= terPrec)
                                {
                                    //r49
                                    AccionReduccion(49);
                        ...
                        case 112:
                            ...
                            else if (Lab_ASDR.TokenList[i] == "(")
                            {
                                ...
                                var terPrec = PrecedenciaTerminales[Lab_ASDR.TokenList[i]];
                                //PRECEDENCIA DE LA PRODUCCION
                                var proPrec = PrecedenciaProducciones[111];
                                if (proPrec > terPrec)
                                {
                                    //r111
                                    AccionReduccion(111);
                        ...
                        case 113:
                            ...
                            else if (Lab_ASDR.TokenList[i] == "||")
                            {
                                ...
                                var terPrec = PrecedenciaTerminales[Lab_ASDR.TokenList[i]];
                                //PRECEDENCIA DE LA PRODUCCION
                                var proPrec = PrecedenciaProducciones[84];
                                if (proPrec >= terPrec)
                                {
                                    //r84
                                    AccionReduccion(84);
                        ...
                        case 114:
                            ...
                            else if (Lab_ASDR.TokenList[i] == "!=")
                            {
                                ...
                                var terPrec = PrecedenciaTerminales[Lab_ASDR.TokenList[i]];
                                //PRECEDENCIA DE LA PRODUCCION
                                var proPrec = PrecedenciaProducciones[87];
                                if (proPrec > terPrec)
                                {
                                    //r87
                                    AccionReduccion(87);
                        ...
                        case 115:
                            ...
                            else if (Lab_ASDR.TokenList[i] == ">")
                            {
                                ...
                                var terPrec = PrecedenciaTerminales[Lab_ASDR.TokenList[i]];
                                //PRECEDENCIA DE LA PRODUCCION
                                var proPrec = PrecedenciaProducciones[91];
                                if (proPrec > terPrec)
                                {
                                    //r91
                                    AccionReduccion(91);
                        ...
                        case 116:
                            ...
                            else if (Lab_ASDR.TokenList[i] == "-")
                            {
                                ...
                                var terPrec = PrecedenciaTerminales[Lab_ASDR.TokenList[i]];
                                //PRECEDENCIA DE LA PRODUCCION
                                var proPrec = PrecedenciaProducciones[94];
                                if (proPrec > terPrec)
                                {
                                    //r94
                                    AccionReduccion(94);
                        ...
                        case 117:
                            ...
                            else if (Lab_ASDR.TokenList[i] == "/")
                            {
                                ...
                                var terPrec = PrecedenciaTerminales[Lab_ASDR.TokenList[i]];
                                //PRECEDENCIA DE LA PRODUCCION
                                var proPrec = PrecedenciaProducciones[98];
                                if (proPrec > terPrec)
                                {
                                    //r98
                                    AccionReduccion(98);
                        ...
                        case 118:
                            ...
                            else if (Lab_ASDR.TokenList[i] == "-")
                            {
                                ...
                                var terPrec = PrecedenciaTerminales[Lab_ASDR.TokenList[i]];
                                //PRECEDENCIA DE LA PRODUCCION
                                var proPrec = PrecedenciaProducciones[102];
                                if (proPrec > terPrec)
                                {
                                    //r102
                                    AccionReduccion(102);
                        ...
                        case 203:
                            ...
                            else if (Lab_ASDR.TokenList[i] == "else")
                            {
                                ...
                                var terPrec = PrecedenciaTerminales[Lab_ASDR.TokenList[i]];
                                //PRECEDENCIA DE LA PRODUCCION
                                var proPrec = PrecedenciaProducciones[65];
                                if (proPrec > terPrec)
                                {
                                    //r65
                                    AccionReduccion(65);
